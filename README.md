...
- 13 种原创鱼类对应 13 个明确等级，终极鱼体型超过幼鱼四倍，进化差异清晰可见
- 成长价值按等级差逐级缩小到三分之一，升级所需同阶鱼数量也随等级提高
- 低阶和同阶鱼均可吞食，同阶鱼提供额外分数，高阶鱼会造成伤害，关系点提供即时提示
- 鱼群从视野外围成组进入并在离开后回收，刷新等级最高不超过玩家等级 `+2`，高等级鱼更加稀有
- 向下深潜会依次进入13级水层：浅海只出现幼鱼，越深的水层越容易刷新高阶鱼
- 玩家等级低于当前水层的安全要求时，短暂警告后每4秒损失1点生命，升级或上浮可解除
- 气泡护盾可抵挡一次捕食者或海雷，声呐贝壳会标记目标方向，狂食海星短时提升速度并延长连吞
- 洋流加速门同时推动玩家、鱼群与危险物；诱饵灯塔会在远处聚集鱼群，也会吸引捕食者和海雷
- 每 45 秒提高一级海压要求，落后时需在 12 秒内完成进化；海压不达标会直接结束本局
- 深渊威胁随时间升至 5 阶，逐步扩大捕食者追踪范围并提高海雷频率、数量与漂移速度
- 经典模式达到 13 级后仍可继续狩猎，海压要求会在 13 级封顶，深渊威胁仍会继续维持
